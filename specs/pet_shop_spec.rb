...
#1
  def test_pet_shop_name
    name = pet_shop_name(@pet_shop) #if <something> = , then it will return something
...
#2
  ...
  def test_add_or_remove_cash__add
    ...
    cash = total_cash(@pet_shop)   #this checks above
    assert_equal(1010, cash)
  end
#3
  def test_add_or_remove_cash__remove
    add_or_remove_cash(@pet_shop,-10) #add_or_remove, then doesnt return anything
...
#7
  def test_all_pets_by_breed__found
    pets = pets_by_breed(@pet_shop, "British Shorthair") #plural =, return a count on array
    assert_equal(2, pets.count) #.count will work on an array,
  end
...
#8
  def test_find_pet_by_name__returns_pet
    ...
    assert_equal("Arthur", pet[:name])  #returns a pet hash
  end
...
#14
  ...
  #   customer = @customers[0]  #this is arranging
  #   pet = find_pet_by_name(@pet_shop,"Arthur") #this is arranging

  #   sell_pet_to_customer(@pet_shop, pet, customer) #this is function line and look back at other functions to call
